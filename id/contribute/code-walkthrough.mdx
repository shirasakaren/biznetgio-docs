...
- `ssh_and_console_user`: string, default `"admin"` (atau `"root"` di `gpu/`). Komentarnya nyatet aturan API: 6 sampai 32 karakter, cuma huruf, angka, dash, dan dot.
