...
Scope nge-namain area-nya, dan dia mencerminkan susunan repo. Contoh beneran dari sejarah repo-repo ini:
...
- Repo docs: situs di biznetgio.creations.ren redeploy otomatis dari `main`.
...
Satu aturan terakhir: project ini gak pake CI pas push, branch protection dengan required check, atau rilis otomatis. Model safety-nya review manusia plus jalanin pipeline manual dengan sengaja. Itu pilihan desain yang dijelasin di [Pipelines](/id/contribute/pipelines), dan itu sebabnya checklist PR lebih penting di sini daripada di kebanyakan repo.
