...
| Input | Type | Required | Notes |
| --- | --- | --- | --- |
| `productId` | int64 | yes | dari `/neolites/disks/products`; liat warning di bawah |
| `cycle` | string | yes | liat warning di bawah |
