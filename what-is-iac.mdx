...
[Pulumi](https://www.pulumi.com) is an IaC tool that lets you write infrastructure in general purpose programming languages: TypeScript, Python, Go, C#, and Java. It also has a declarative YAML mode for when you want Terraform-style config without a full SDK - see the [Pulumi quickstart](/pulumi-quickstart) for a YAML example next to the five language ones.
...
| | Terraform | Pulumi |
| --- | --- | --- |
| Language | HCL (declarative DSL) | TypeScript, Python, Go, C#, Java, or declarative YAML |
