...
Production is the default when `base_url` / `baseUrl` is omitted. Point the providers at staging by setting it explicitly, e.g. `export BIZNETGIO_BASE_URL="https://api.portal.biznetgio.dev/v1"`.
