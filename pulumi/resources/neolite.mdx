...
| Input | Type | Required | Notes |
| --- | --- | --- | --- |
| `productId` | int64 | yes | from `/neolites/disks/products`; see warning below |
| `cycle` | string | yes | see warning below |
