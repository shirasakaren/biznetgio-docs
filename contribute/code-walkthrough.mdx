...
- `ssh_and_console_user`: string, default `"admin"` (or `"root"` in `gpu/`). The comments note the API rule: 6 to 32 characters, letters, numbers, dash, dot only.
