...
Issues are how bugs and ideas enter the project. Both example repos have three structured issue forms, configured as YAML under `.github/ISSUE_TEMPLATE/`, using GitHub's [issue forms](https://docs.github.com/en/communities/using-templates-to-encourage-useful-issues-and-pull-requests/configuring-issue-templates-for-your-repository) feature. The docs repo does not have its own issue forms yet - open a plain issue there, or use one of the example repos' forms if the bug is really about a specific example.
