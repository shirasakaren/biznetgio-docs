...
<CardGroup cols={2}>
  ...
  <Card title="Product Catalog" icon="server" href="/products/overview">
    What `products[0]` and `oss[0]` actually resolve to, real pricing per package, and how to pick a specific one on purpose.
  </Card>
  ...
  <Card title="Example repos" icon="code" href="/tutorials/examples">
    Two repositories with every resource as a runnable, commented example, ready to copy as a template.
  </Card>
  <Card title="Contribute" icon="handshake" href="/contribute/introduction">
    Conventions, templates, pipelines, and step-by-step walkthroughs for collaborating on this project.
  </Card>
...
| Terraform examples | [shirasakaren/biznetgio-example-terraform](https://github.com/shirasakaren/biznetgio-example-terraform) | MIT |
| Pulumi examples | [shirasakaren/biznetgio-example-pulumi](https://github.com/shirasakaren/biznetgio-example-pulumi) | MIT |
| This documentation | [shirasakaren/biznetgio-docs](https://github.com/shirasakaren/biznetgio-docs) | MIT |
...
- [Product Catalog](/products/overview) - real pricing, real specs, and how to pick a specific package or OS instead of trusting index `[0]`
...
- [Example repos](/tutorials/examples) - complete runnable examples of every resource, in both tools, ready to copy as a template
- [Contribute](/contribute/introduction) - how the project is organized and how to contribute to the providers, examples, and docs
